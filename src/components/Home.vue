  ...
  <section class="home">
    <div class="notepaper">
      <figure class="quote">
          ...
          <figcaption class="quote-by">— Steve Jobs</figcaption>
      </figure>
    </div>
  </section>
</template>
...
.notepaper {
  ...
  background-image: -webkit-radial-gradient(center, farthest-corner, rgba(255, 255, 255, 0.7) 0%, rgba(255, 255, 255, 0.1) 90%), -webkit-repeating-linear-gradient(top, transparent 0%, transparent 29px, rgba(239, 207, 173, 0.7) 29px, rgba(239, 207, 173, 0.7) 30px);
